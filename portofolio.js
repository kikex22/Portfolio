    ...
    data(){
        return{
            ...
            servicios: [
              ...
              projects:[
                {type:"projects", 
                text:"The Portable Monitoring and Treatment System Controller with Electrostimulation assists patients with mobility impairments using three ESP32-based devices communicating via Wi-Fi. It integrates gyroscopes and sensors for motion tracking, controls EMS/TENS stimulation, and features a remote controller for therapy management. Developed in C++, it ensures efficient performance and system integration.",
             type:"projects",text2:"StimBoyWeb is a web-based user manual and documentation platform detailing the StimBoy project’s design, functionality, and development. Built with CSS, JavaScript, HTML, Bootstrap, and Vue.js, it provides clear, structured, and user-friendly documentation. "
             ...
             text3:"This project implements a Wi-Fi-controlled car with noise and smoke sensors to detect environmental anomalies. Real-time data is transmitted to the remote controller, providing critical insights. Developed in C++, it ensures efficient performance and seamless system integration.",
            },
        ],
              isVisible:[],
              ProjectVisible:[],
